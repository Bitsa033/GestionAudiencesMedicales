    ...
    <div class="container px-4 px-lg-12">
        <div class="row gx-4 gx-lg-5 justify-content-center">
            ...
            <div class="col-lg-8 col-xl-6 text-center">
                <h2 class="mt-0">Données des medecins enregistrés!</h2>
                <hr class="divider" />
            </div>
        </div>
                ...
                <table class="table table-bordered">
                    <thead class="table-danger">
                        <tr>
                            ...
                            <td>Domaine</td>
                            <td>
                                <a href="{{url('new_medecin')}}" class="btn btn-primary"><i class="fa fa-plus"></i> Nouvel enregistrement</a>
                            </td>
                        </tr>
                    </thead>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="width: 45%;">
                                ...
                                <a href="{{route('new_audience',$item->id)}}" class="btn btn-info"> <i class="fa fa-th"></i>  Agenda</a>
                            </td>
